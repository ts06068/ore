...
ACTION_MODELS={
 ...
 'search':schema('Search',source=(str,...),query=(str,...),year_from=(int|None,None),year_to=(int|None,None),journals=(list[str]|None,None),limit=(int,Field(default=20,ge=1,le=200)),cursor=(str|None,None)),
 ...
 'download':schema('Download',url=(str,...),resource_id=(str,...),role=(Literal['main_pdf','supplement','full_text','attachment','full_text_xml','full_text_text','media'],...),filename=(str|None,None),doi=(str|None,None),title=(str|None,None),version=(str|None,None),session_id=(str|None,None)),
 'artifact_commit':schema('ArtifactCommit',session_id=(str,...),download_index=(int,Field(ge=0)),resource_id=(str,...),role=(str,...),doi=(str|None,None),title=(str|None,None),version=(str|None,None)),
...
def validate_action(name,args):
    ...
    return ACTION_MODELS[name].model_validate(args).model_dump(exclude_none=True)
