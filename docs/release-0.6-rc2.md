...
The merged archive is `.ore/reports/ore-four-source-sample-rc2.zip` (**36,223,352 bytes**, SHA-256 `68fe955781632c586dc9ad7651df084143db0d5b9c913a2e8b51a0a541bd1c56`). All 49 files passed size/hash and applicable PDF/ZIP checks; Office and MP4 attachments retain their original formats. Its manifest records source membership, provenance, hashes, deduplication and limitations. Independent merge verification is recorded in `.ore/rc2-completion/corpus-verification.json`. See [initial PubMed/Scopus evidence](release-0.6-sources.md), [KISS/RISS continuation](release-0.6-rc2-sources.md) and [validation](../VALIDATION.md).
